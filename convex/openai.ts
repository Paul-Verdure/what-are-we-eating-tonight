...
export const getRecipesTitles = action({
  ...
  handler: async (_ctx, { ingredients, preferences }) => {
    ...
    Provide an RFC8259 compliant JSON response with an array of objects. Each object should contain the keys "title" and "description" with corresponding recipe title and description values. Do not include any explanations or additional text outside the JSON array.
